...
parser.add_argument('--ngames', type=int, metavar='n', default='3000', help='number of games to simulate') #1250
...
def main():
    ...
    if not val_mode:
        ...
        for graph_ in range(args.graph_nbr):
            ...
            graph_dic_train[graph_] = graph.Graph(num_nodes=args.n_node,
                                            k_nn=args.knn,
